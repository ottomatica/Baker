...
describe('baker should create VM and destroy it', function() {
    ...
    it('should have running node server', function(done) {
        var child = child_process.exec('node cmd.js bake --local test/resources/baker-test', function(error, stdout, stderr){
    ...
    it('should destroy VM', function(done) {
        var child = child_process.exec('node cmd.js destroy baker-test', function(error, stdout, stderr)
        {
            console.log(stderr);
